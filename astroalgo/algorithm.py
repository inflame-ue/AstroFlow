...
class SimulateMission:
    ...
    def find_next_optimal_target(self, current_orbit_idx):
        """Find the next optimal satellite to intercept (wait time in seconds)"""
        ...
        for satellite in next_orbit.satellites:
            ...
            total_time = wait_time + transfer.transfer_time # Both are physical seconds
